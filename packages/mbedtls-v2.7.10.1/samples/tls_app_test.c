...
//https://api.seniverse.com/v3/weather/now.json?key=S21jPVZPvEVcB69Es&location=nanyang
// https://www.rt-thread.org/download/rt-thread.txt
#define MBEDTLS_WEB_SERVER  "api.seniverse.com"
#define MBEDTLS_WEB_PORT    "443"

#define MBEDTLS_READ_BUFFER 1024

static const char *REQUEST = "GET /v3/weather/now.json?key=S21jPVZPvEVcB69Es&location=nanyang HTTP/1.1\r\n"
